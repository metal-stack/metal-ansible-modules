...
class TestMetalMachineModule(MetalModules):
    def setUp(self):
        self.defaultSetUpTasks()

        import metal_machine
        self.module = metal_machine
    ...
    def test_machine_present_already_exists(self, mocks):
        set_module_args(
            dict(
                api_url="http://somewhere",
                api_hmac="hmac",
        ...
        mocks.assert_called()
        mocks.assert_called_with(models.V1MachineFindRequest(
    ...
    def test_machine_present_allocate(self, allocate_mock, find_mock):
        set_module_args(
            dict(
                api_url="http://somewhere",
                api_hmac="hmac",
        ...
        allocate_mock.assert_called_with(models.V1MachineAllocateRequest(
            ...
            networks=[models.V1MachineAllocationNetwork(
                autoacquire=True, networkid="internet")],
            ips=[],
            ssh_pub_keys=[],
            tags=["ci.metal-stack.io/manager=ansible"],
        ))
    ...
    def test_machine_present_allocate_no_auto(self, allocate_mock, find_mock):
        ...
        allocate_mock.assert_called_with(models.V1MachineAllocateRequest(
            ...
            sizeid="c1",
            networks=[models.V1MachineAllocationNetwork(
                autoacquire=False, networkid="internet")],
            ips=[],
            ssh_pub_keys=[],
            tags=["ci.metal-stack.io/manager=ansible"],
        ))
